...
{
    public partial class FilePaths9 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_FilePath_ApplicationUser_UserId", table: "FilePath");
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_ProfilePhoto_ApplicationUser_UserId",
                table: "FilePath",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Category_Group_GroupId", table: "Category");
            migrationBuilder.DropForeignKey(name: "FK_Connection_Family_FamilyId", table: "Connection");
            migrationBuilder.DropForeignKey(name: "FK_ProfilePhoto_ApplicationUser_UserId", table: "FilePath");
            migrationBuilder.DropForeignKey(name: "FK_SubCategory_Category_CategoryId", table: "SubCategory");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_IdentityRole_RoleId",
                table: "AspNetRoleClaims",
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Restrict);
            migrationBuilder.AddForeignKey(
                name: "FK_FilePath_ApplicationUser_UserId",
                table: "FilePath",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
