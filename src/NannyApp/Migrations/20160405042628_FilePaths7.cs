...
{
    public partial class FilePaths7 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_ActivityPhoto_Activity_ActivityId1",
                table: "FilePath",
                column: "ActivityId1",
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_Child_FilePath_ChildPhotoId",
                table: "Child",
                column: "ChildPhotoId",
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_Family_FilePath_FamilyPhotoId",
                table: "Family",
                column: "FamilyPhotoId",
                principalTable: "FilePath",
                principalColumn: "Id",
                onDelete: ReferentialAction.Restrict);
            migrationBuilder.AddForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_ApplicationUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_ActivityPhoto_Activity_ActivityId1", table: "FilePath");
            migrationBuilder.DropForeignKey(name: "FK_Category_Group_GroupId", table: "Category");
            migrationBuilder.DropForeignKey(name: "FK_Child_FilePath_ChildPhotoId", table: "Child");
            migrationBuilder.DropForeignKey(name: "FK_Connection_Family_FamilyId", table: "Connection");
            migrationBuilder.DropForeignKey(name: "FK_Family_FilePath_FamilyPhotoId", table: "Family");
            migrationBuilder.DropForeignKey(name: "FK_FilePath_Activity_ActivityId", table: "FilePath");
            migrationBuilder.DropForeignKey(name: "FK_SubCategory_Category_CategoryId", table: "SubCategory");
            migrationBuilder.DropColumn(name: "ActivityId1", table: "FilePath");
            migrationBuilder.DropColumn(name: "FamilyPhotoId", table: "Family");
            migrationBuilder.DropColumn(name: "ChildPhotoId", table: "Child");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_IdentityRole_RoleId",
                table: "AspNetRoleClaims",
                column: "RoleId",
